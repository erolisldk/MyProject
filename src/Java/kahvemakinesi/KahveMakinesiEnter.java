...
public class KahveMakinesiEnter {

    public static void main(String[] args) {
        KahveMakinesiEnter start = new KahveMakinesiEnter();
        start.showMenu();
    ...
    void showMenu() {
        ...
        do {
            ...
            System.out.println("*************************************************************************************");
            option = scan.nextLine().toUpperCase(Locale.ROOT); // String option' u yukarida deklare etmem lazim yoksa asagida while gormez
            System.out.println("\n");
        ...
        System.out.println("Thank you for visiting COFFEE HAYAL!!");
    }
